...
class TermsOfUsePage extends StatelessWidget {
  ...
  final String txtFullContract =
      '\n##### Contrato completo            \n Exceto conforme expressamente previsto em um "aviso legal" específico no site, estes termos (incluindo a Política de Privacidade do MPI Brasil) constituem o contrato completo entre você, Instituto SocialTech e MPI Brasil com relação ao seu uso (e uso anterior) ao **Aplicativo MPI Brasil**. \n\n Estes termos constituem o entendimento e acordo completo e exclusivo entre Instituto SocialTech, MPI Brasil e você em relação ao aplicativo, e estes termos substituem e substituem todos e quaisquer entendimentos ou acordos orais ou escritos anteriores entre a Instituto SocialTech, MPI Brasil e você em relação ao aplicativo.';
